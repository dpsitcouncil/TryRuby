...
Shakespeare from the internet. (Don't worry it actually comes from the same server that this website runs on, so we're not bothering anyone.)
...
> RSS on Google News -- <a href="http://news.google.com/news/section?q=ruby&output=rss" target="_blank">here</a>